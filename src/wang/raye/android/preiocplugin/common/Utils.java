package wang.raye.android.preiocplugin.common;
...
import wang.raye.android.preiocplugin.Settings;
...
public class Utils {
     ...
     *
     * @param preIOC PreIOC version
     * @param annotation
     * @return
     */
    public static String getInjectionID(@NotNull IPreIOC preIOC, String annotation) {
        String id = null;
        ...
        Matcher matcher = preIOC.getFieldAnnotationPattern().matcher(annotation);
        if (matcher.find()) {
            id = matcher.group(1);
        }
    ...
    /**
     * Check whether classpath of a module that corresponds to a {@link com.intellij.psi.PsiElement} contains given class.
     *
